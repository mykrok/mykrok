...
cd src/strava_backup/assets/map-browser/
...
uv run strava-backup create-browser --serve
...
uv run python -c "from strava_backup import __version__; print(__version__)"
...
1. Check `src/strava_backup/assets/map-browser/` for the file
